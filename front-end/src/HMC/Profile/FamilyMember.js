            ...
            <Card >
                ...
                <Card.Body className='Design-sprint text-center'>
                    <ul className="design-image mb-4">
                        <li>
                            <img className="rounded-circle m-4" style={{width: '70px'}} src={avatar1} alt="chat-user"/>
                            <h6>Test User</h6>
                            <span>Father</span>
                        </li>
                        <li>
                            <img className="rounded-circle m-4" style={{width: '70px'}} src={avatar2} alt="chat-user"/>
                            <h6>Test User</h6>
                            <span>Child</span>
                        </li>
                        <li>
                            <img className="rounded-circle m-4 " style={{width: '70px'}} src={avatar3} alt="chat-user"/>
                            <h6>Test User</h6>
                            <span>Child</span>
                        </li>
