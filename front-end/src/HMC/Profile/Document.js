...
import {Card, Col, Row, Table, InputGroup,Form, DropdownButton,Dropdown} from 'react-bootstrap'
                        ...
                        <Col xl={6}>
                            <Form>
                                <InputGroup className="mb-3">
                                            <DropdownButton as={InputGroup.Prepend} title="Document Type" id="input-group-dropdown-1">
                                ...
                                <a href={DEMO.BLANK_LINK} className="btn theme-bg text-uppercase text-white float-right"><i className="feather icon-user-plus f-20 text-white"/>Upload Document</a>
