                ...
                <Col md={6} xl={6}>
                        <Card className='theme-bg earning-date'>
                            <Card.Header className='borderless'>
                                <Card.Title as='h5' className='text-white'>Upcoming Appointment</Card.Title>
                            </Card.Header>
                            <Card.Body>
                                    ...
                                    <Tab.Container id="left-tabs-example" defaultActiveKey="mon">
                                        <Tab.Content>
                                            <Tab.Pane eventKey="mon">
                                                ...
                                                <span className="text-white mb-2 d-block">Check up appointment</span>
                                                <span className="text-white mb-4 d-block"> @ Boston Medical Center</span>
                                            </Tab.Pane>
                                            <Tab.Pane eventKey="tue">
                                                <h3 className="text-white mb-4 f-w-300">No appointment</h3>
                                                <a href={DEMO.BLANK_LINK} className="btn btn-primary shadow-2 text-uppercase btn-block mb-4" style={{maxWidth: '300px', margin: '0 auto'}}>Add New Appt</a>
                                            </Tab.Pane>
                            ...
                            <Card.Body>
                                ...
                                <ul className="task-list">
                                    <li>
                                        ...
                                        <h6>Cholesterol Testing<span className="float-right text-muted">Monthly</span></h6>
                                        <p className="text-muted">Lorem ipsum is dolorem…</p>
                                    </li>
                                    <li>
                                        <i className="task-icon bg-c-green"/>
                                        <h6>Blood Pressure Monitor<span className="float-right text-muted">Daily</span></h6>
                                        <p className="text-muted">Lorem ipsum is dolorem…</p>
                                    </li>
                                </ul>
